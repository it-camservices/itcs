...
<div style="width:244px;">
   <div style="padding:2px 10px; width:100%;font-size:100%;">
   		<table border="0" cellpadding="3">
      		<tr>
            	<td><img src="images/visitor/vtoday.png" /></td>
                <td>Online</td> 
                <td>:</td>
                <td><?php echo $online; ?></td>
          	</tr>
           	<tr>
            	<td><img src="images/visitor/vyesterday.png" /></td>
                <td>Today</td>
                <td>:</td>
				<td><?php echo $day_value; ?></td>
          	</tr>
      		<tr>
            	<td><img src="images/visitor/vlweek.png" /></td>
                <td>Yesterday</td>
                <td>:</td>
                <td> <?php echo $yesterday_value; ?></td>
         	</tr>
            <tr>
      			<td><img src="images/visitor/vlweek (1).png" /></td>
                <td>Week</td>
                <td>:</td>
                <td> <?php echo $week_value; ?></td>
          	</tr>
            <tr>
      			<td><img src="images/visitor/vmonth.png" /></td>
                <td>Month</td>
                <td>:</td>
                <td> <?php echo $month_value; ?></td>
          	</tr>
            <tr>
      			<td><img src="images/visitor/vmonth.png" /></td>
                <td>Year</td>
                <td>:</td>
				<td><?php echo $year_value; ?></td>
         	</tr>
            <tr>
      			<td><img src="images/visitor/vall.png" /></td>
                <td>Total</td>
                <td>:</td>
                <td><?php echo $all_value; ?></td>
         	</tr>
            <tr>
            	<td>Record</td>
                <td>:</td>
                <td colspan="2"><?php echo $record_value; ?> (<?php echo date("d.m.Y", strtotime($record_date)) ?>)</td>
          	</tr>
        </table>
   </div>
</div>
