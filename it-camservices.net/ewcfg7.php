...
define("EW_PROJECT_NAME", "itcam", TRUE); // Project name
define("EW_RANDOM_KEY", 'Efikamwpf2tHimHB', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "itcam.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'itcam_db', TRUE);
...
define("EW_ADMIN_PASSWORD", "admin123", TRUE); // Administrator password
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../media/", TRUE); // Upload destination path (relative to app root)
