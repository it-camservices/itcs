...
?>
<form name="ftbl_experiencesadd" id="ftbl_experiencesadd" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data">
<p>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("AddBtn")) ?>" onclick="ew_SubmitForm(tbl_experiences_add, this.form);">
</form>
<script type="text/javascript">
<!--
