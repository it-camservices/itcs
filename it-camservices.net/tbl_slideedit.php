...
?>
<form name="ftbl_slideedit" id="ftbl_slideedit" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data">
<p>
...
ew_DHTMLEditors.push(new ew_DHTMLEditor("x_description", function() {
	...
	var oFCKeditor = new FCKeditor('x_description', 35*_width_multiplier, 4*_height_multiplier);
...
<p>
<input type="button" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("EditBtn")) ?>" onclick="ew_SubmitForm(tbl_slide_edit, this.form);">
</form>
<script type="text/javascript">
<!--
