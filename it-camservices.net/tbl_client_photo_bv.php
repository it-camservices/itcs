...
// Create page object
$tbl_client_photo_blobview = new ctbl_client_photo_blobview();
$Page =& $tbl_client_photo_blobview;

// Page init
$tbl_client_photo_blobview->Page_Init();

// Page main
$tbl_client_photo_blobview->Page_Main();
?>
<?php
$tbl_client_photo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ctbl_client_photo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'tbl_client_photo_blobview';
	...
	//
	function ctbl_client_photo_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('tbl_client', 'x_photo');
