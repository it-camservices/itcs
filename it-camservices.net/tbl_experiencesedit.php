...
?>
<form name="ftbl_experiencesedit" id="ftbl_experiencesedit" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return tbl_experiences_edit.ValidateForm(this);">
<p>
