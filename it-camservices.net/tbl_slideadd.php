...
?>
<form name="ftbl_slideadd" id="ftbl_slideadd" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data">
<p>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("AddBtn")) ?>" onclick="ew_SubmitForm(tbl_slide_add, this.form);">
</form>
<script type="text/javascript">
<!--
