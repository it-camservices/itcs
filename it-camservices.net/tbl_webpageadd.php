...
?>
<form name="ftbl_webpageadd" id="ftbl_webpageadd" action="<?php echo ew_CurrentPage() ?>" method="post">
<p>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("AddBtn")) ?>" onclick="ew_SubmitForm(tbl_webpage_add, this.form);">
</form>
<script type="text/javascript">
<!--
