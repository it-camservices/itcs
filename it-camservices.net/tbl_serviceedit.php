...
?>
<form name="ftbl_serviceedit" id="ftbl_serviceedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return tbl_service_edit.ValidateForm(this);">
<p>
...
ew_DHTMLEditors.push(new ew_DHTMLEditor("x_description", function() {
	var oCKeditor = CKEDITOR.replace('x_description', { width: 50*_width_multiplier, height: 7*_height_multiplier, autoUpdateElement: false, baseHref: 'ckeditor/'});
	this.active = true;
}));
-->
</script>
